// ─────────────────────────────────────────────  
// ⚙️ TokitoBot | Configuración Global (8 dígitos)  
// ─────────────────────────────────────────────  
...
export const botNumber = '+573208204068' // Número exclusivo del bot  
export const owner = ['+573004828388']    // Número principal como dueño (solo referencia)  
export const sockers = []                 // Subdevs / testers (vacío si no hay)  
export const mods = []                    // Moderadores  
export const prems = []                   // Premium users  

// Método de autenticación: 'pairing' para código de 8 dígitos  
export const authMethod = 'pairing'  
export const phoneNumber = '+573208204068'  // Número del bot para vinculación  
...
export const MuichiroJadibots = true  
